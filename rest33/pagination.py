...
from rest33.exceptions import NotFound
from rest33.response import Response
from rest33.settings import api_settings
from rest33.utils.urls import remove_query_param, replace_query_param
...
class PageNumberPagination(BasePagination):
    ...
    template = 'rest33/pagination/numbers.html'
...
class CursorPagination(BasePagination):
    ...
    ordering = '-created'
    template = 'rest33/pagination/previous_and_next.html'
