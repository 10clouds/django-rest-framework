...
from rest33 import VERSION, exceptions, serializers, status
from rest33.compat import (
    INDENT_SEPARATORS, LONG_SEPARATORS, SHORT_SEPARATORS
)
from rest33.exceptions import ParseError
from rest33.request import is_form_media_type, override_method
from rest33.settings import api_settings
from rest33.utils import encoders
from rest33.utils.breadcrumbs import get_breadcrumbs
from rest33.utils.field_mapping import ClassLookupDict
...
class BrowsableAPIRenderer(BaseRenderer):
    ...
    filter_template = 'rest33/filters/base.html'
    charset = 'utf-8'
    ...
    def get_rendered_html_form(self, data, view, method, request):
        ...
        with override_method(view, request, method) as request:
            ...
            return form_renderer.render(
                ...
                {'style': {'template_pack': 'rest33/horizontal'}}
            )
