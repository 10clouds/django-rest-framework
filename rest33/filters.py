...
if 'crispy_forms' in settings.INSTALLED_APPS and crispy_forms and django_filters:
    ...
    filter_template = 'rest33/filters/django_filter_crispyforms.html'
    ...
    filter_template = 'rest33/filters/django_filter.html'
...
class SearchFilter(BaseFilterBackend):
    ...
    template = 'rest33/filters/search.html'
...
class OrderingFilter(BaseFilterBackend):
    ...
    template = 'rest33/filters/ordering.html'
