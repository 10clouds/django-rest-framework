...
import rest33.utils.model_meta
from rest33.utils.breadcrumbs import get_breadcrumbs
from rest33.utils.model_meta import _resolve_model
...
class ResolveModelWithPatchedDjangoTests(TestCase):
    ...
    def setUp(self):
        ...
        self.get_model = rest33.utils.model_meta.apps.get_model

        def get_model(app_label, model_name):
            return None

        rest33.utils.model_meta.apps.get_model = get_model

    def tearDown(self):
        """Revert monkeypatching."""
        rest33.utils.model_meta.apps.get_model = self.get_model
