...
Configuration for REST framework is all namespaced inside a single Django setting, named `REST33`.
...
Default: `'rest33.negotiation.DefaultContentNegotiation'`
...
Default: `rest33.pagination.PaginationSerializer`
...
Default: `'rest33.views.get_view_name'`
...
Default: `'rest33.views.get_view_description'`
...
Default: `'rest33.views.exception_handler'`
